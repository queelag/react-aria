...
const ROOT_PROPS_KEYS: (keyof RadioGroupProps)[] = ['checkedItemIndex', 'onCheckItem']
...
export function Root(props: RadioGroupProps) {
  ...
  return (
    <div {...ObjectUtils.omit(props, ROOT_PROPS_KEYS)} onKeyDown={onKeyDown} role='radiogroup'>
      {props.children({
